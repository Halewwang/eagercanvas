...
test('workspace template canvas preview renders a screenshot-like graph instead of oversized placeholder cards', () => {
  const previewSource = readWorkspaceComponentSource('WorkspaceTemplateCanvasPreview')

  assert.match(previewSource, /getWorkspaceTemplatePreviewEdges/)
  assert.match(previewSource, /<svg[\s\S]*class="template-canvas-edges"/)
  assert.match(previewSource, /class="template-canvas-edge"/)
  assert.match(previewSource, /v-if="node\.mediaUrl"/)
  assert.match(previewSource, /:src="node\.mediaUrl"/)
  assert.match(previewSource, /v-else-if="node\.text"/)
  assert.match(previewSource, /template-canvas-node-text/)
